...
const ExpiryDate =()=>{
    const{dateMonth, setDateMonth, isdateMonthValid,dateMonthError, setDateMonthErrorOnChange, setDateMonthErrorOnBlur, dateYear, isdateYearValid, setDateYear, dateYearError, setIsDateYearValid,  setDateYearErrorOnChange, setDateYearErrorOnBlur}=useGlobalContext();
    ...
    <div className="form-group form-group-grid card__expiry">
        ...
        onBlur={(e)=>{setDateMonthErrorOnBlur()}} maxLength={2} /><div className="card__expiry-inputs--divider">/</div><input type="text" />
        </div>
    </div>
    )
}
